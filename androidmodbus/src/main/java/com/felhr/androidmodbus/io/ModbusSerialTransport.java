 ...
 */
package com.felhr.androidmodbus.io;

import android.util.Log;

import com.felhr.androidmodbus.Modbus;
import com.felhr.androidmodbus.ModbusIOException;
import com.felhr.androidmodbus.msg.ModbusMessage;
import com.felhr.androidmodbus.msg.ModbusRequest;
import com.felhr.androidmodbus.msg.ModbusResponse;
import com.felhr.androidmodbus.net.AbstractModbusListener;
import com.felhr.androidmodbus.net.AbstractSerialConnection;
import com.felhr.androidmodbus.util.ModbusUtil;
...
public abstract class ModbusSerialTransport extends AbstractModbusTransport {
    ...
    private void writeMessage(ModbusMessage msg) throws ModbusIOException {
        ...
        double bytesPerSec = commPort.getBaudRate() / (((commPort.getNumDataBits() == 0) ? 8 : commPort.getNumDataBits()) + ((commPort.getNumStopBits() == 0) ? 1 : commPort.getNumStopBits()) + ((commPort.getParity() == AbstractSerialConnection.NO_PARITY) ? 0 : 1));
